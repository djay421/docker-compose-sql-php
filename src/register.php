...
<head>
    ...
    <title>Register — RevZone Scooter Parts</title>
...
<div class="auth-container">
    <div class="auth-card">
        <div class="auth-header">
            ...
            <p class="auth-subtitle">Create your account to start shopping premium parts</p>
        </div>
        ...
        <form method="POST" class="auth-form">
            <div class="form-group">
                ...
                <input type="text" name="username" class="form-input" placeholder="Choose your username" required autofocus>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password_confirm" class="form-input" placeholder="Re-enter password" required>
                </div>
            </div>
        ...
        <div class="auth-divider">
            <span class="auth-divider-text">ALREADY A MEMBER?</span>
        </div>
